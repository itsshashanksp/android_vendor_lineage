...
define addVar
  ...
  SOONG_CONFIG_stagVarsPlugin_$(1) := $($1)
endef
...
SOONG_CONFIG_stagGlobalVars_target_powershare_path := $(TARGET_POWERSHARE_PATH)
SOONG_CONFIG_stagGlobalVars_target_powershare_enabled := $(TARGET_POWERSHARE_ENABLED)
SOONG_CONFIG_stagGlobalVars_target_powershare_disabled := $(TARGET_POWERSHARE_DISABLED)
